...
export default function Contacts() {
  ...
  return (
    <section id="contacts" className="mx-auto max-w-7xl px-6 py-20">
      <h2 className="text-2xl sm:text-3xl font-semibold tracking-tight">Контакты</h2>
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-3">
          <a href="tel:+79317092518" className="inline-flex items-center gap-2 text-white">
            <Phone size={18} /> +7 931 709-25-18
          </a>
          <a href="mailto:info@aurumadvisory.ru" className="inline-flex items-center gap-2 text-white/90">
            <Mail size={18} /> info@aurumadvisory.ru
          </a>
          <div className="text-white/60">
            ИП Шаренко Екатерина Юрьевна • ОГРНИП 240402702297
          </div>
        </div>
        ...
        <form
          onSubmit={(e) => {
            ...
            if (contactInput && !validateContact(contactInput.value)) {
              contactInput.setCustomValidity("Укажите телефон или e‑mail в корректном формате");
